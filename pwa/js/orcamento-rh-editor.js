...
function renderOrcamentoFotosSection(meta) {
  ...
  return `
    <section class="review-orc-fotos" aria-label="Fotos na proposta">
      ...
      <p class="text-muted review-orc-field-hint">Opcional — até ${MAX_ORCAMENTO_FOTOS} fotografias. Para o modelo antigo (foto ao lado das especificações), escolha «Ao lado do equipamento».</p>
