...
/** Distância do fundo da página até ao fim do conteúdo (manual e autoTable). */
export const PDF_CONTENT_SAFE_BOTTOM_MM = PDF_PAGE_H - PDF_PAGE_NUMBER_Y + 4;
export const PDF_AUTOTABLE_MARGIN_BOTTOM_MM = PDF_CONTENT_SAFE_BOTTOM_MM;
