...
export function mapRowToReport(row) {
  ...
  return {
    ...
    data: {
      ...
      clienteEmailPendingAt: dados.clienteEmailPendingAt || null,
      clienteEmailLastError: dados.clienteEmailLastError || null,
  ...
  const dados = buildRelatorioAuditDados(
    {
      ...
      clienteEmailPendingAt: data.clienteEmailPendingAt || null,
      clienteEmailLastError: data.clienteEmailLastError || null,
